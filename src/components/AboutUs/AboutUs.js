                ...
                <div className="container py-5">
                    <div className="row h-100 align-items-center py-5">
                        <div className="col-lg-6">
                            ...
                            <p className="lead text-muted mb-0">Create a minimal about us page using Bootstrap.</p>
                        ...
                        <div className="col-xl-3 col-sm-6 mb-5">
                            <div className="bg-white rounded shadow-sm py-5 px-4"><img src="https://bootstrapious.com/i/snippets/sn-about/avatar-4.png" alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                                ...
                                <ul className="social mb-0 list-inline mt-3">
                                    ...
                                    <li className="list-inline-item"><Link to="#" className="social-link"><BsWhatsapp/></Link></li>
                                    <li className="list-inline-item"><Link to="#" className="social-link"><BsYoutube/></Link></li>
                                </ul>
                            </div>
                        </div>
